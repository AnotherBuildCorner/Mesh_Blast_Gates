/* V2 has changed pinouts, and hopefully will add power monitoring controls to stop burning chipsets.
...
#define BoardSel 2
const int debounce[NUM_BOARDS] = {500,250,250};
